...
<script type="text/javascript">
    function fetchReport() {
        ...
        var table = $('#data-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route('fetchReport')); ?>',
            columns: [
                // {
                //     data: 'id',
                //     name: 'id'
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_8.2\htdocs\ICBT\resources\views/report/index.blade.php ENDPATH**/ ?>