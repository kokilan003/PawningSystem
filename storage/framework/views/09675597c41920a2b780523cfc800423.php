    ...
    <script>
        function fetchInvoice() {
            ...
            var table = $('#invoice-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('fetchinvoice')); ?>',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
        ...
        <td class="article_name"><select id="article_name" name="article_name" class="col-md">
                                        ...
                                        <?php $__currentLoopData = App\Models\Article::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($article->name); ?>">
        ...
        <td  class="carratage">
                                    <select  id="carratage" name="carratage" class="col-md">
                                        <option value="">Select One</option>
                                        <?php $__currentLoopData = App\Models\Carratage::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carratage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($carratage->carratage_value); ?>" id=<?php echo e($carratage->value_per_gram); ?>>
                                            <?php echo e($carratage->carratage_value); ?>
        ...
        $(document).on('change', '#data-table .carratage', function() {
            ...
            $.ajax({
                dataType: 'json',
                async: false,
                url: "<?php echo e(route('invoice.getcarratage')); ?>",
                data: {
                    "id": carratage
                },
                type: 'get',
        ...
        function saveInvoice() {
            ...
            $.ajax({
                url: "<?php echo e(route('invoice.saveInvoice')); ?>",
                method: 'POST',
                data: {
        ...
        function viewInvoice(id) {
            ...
            $.ajax({
                dataType: 'json',
                async: false,
                url: "<?php echo e(route('invoice.getInvoice')); ?>",
                data: {
                    "id": id
                },
                type: 'get',
            ...
            $('.printpdf').attr("href", "<?php echo e(URL::to('/pdf')); ?>" + '/' + id);
        ...
        function billing(id) {
            ...
            $('#payment').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('invoice.savePayment')); ?>",
                    method: 'POST',
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        data: data,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_8.2\htdocs\ICBT\resources\views/invoice/invoice.blade.php ENDPATH**/ ?>