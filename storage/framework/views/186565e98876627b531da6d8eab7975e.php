        ...
        <script type="text/javascript">
            function fetchArticle() {
                ...
                var table = $('#data-table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '<?php echo e(route('fetcharticles')); ?>',
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_8.2\htdocs\ICBT\resources\views/article/index.blade.php ENDPATH**/ ?>