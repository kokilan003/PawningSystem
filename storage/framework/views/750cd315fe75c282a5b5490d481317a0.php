<?php $__env->startSection('title', 'Add Article'); ?>
    ...
    <script>
        function fetchInterest() {
            ...
            var table = $('#data-table').DataTable({
                ...
                serverSide: true,
                autoWidth: false,
                ajax: '<?php echo e(route('fetchInterset')); ?>',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_8.2\htdocs\ICBT\resources\views/interest/index.blade.php ENDPATH**/ ?>