        ...
        <script type="text/javascript">
            function fetchUser() {
                ...
                var table = $('#data-table').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '<?php echo e(route('fetchUser')); ?>',
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_8.2\htdocs\ICBT\resources\views/user/index.blade.php ENDPATH**/ ?>